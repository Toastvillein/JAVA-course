...
public class Main {
    public static void main(String[] args) {
        ...
        // 1. 익명클래스를 직접 만들어서 변수에 담아 매개변수로전달
        ...
        List<Integer> ret3 = arrayList.stream() // 1. 데이터 준비
        ...
        List<Integer> ret4 = arrayList.stream() // 1. 데이터 준비
        ...
        List<Integer> ret6 = arrayList.stream() // 1. 데이터 흐름 준비 (1,2,3,4,5)
                ...
                .collect(Collectors.toList()); //4. 최종연산
